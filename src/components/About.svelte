  ...
  const contributors = [
    {
      ...
      title: "Maintainer",
      message:
        'Got questions? Find me on the <a href="https://discord.com/invite/afkarena" target="_blank" rel="noreferrer noopener">AFK Arena Discord</a>!',
      website: "",
    },
    {
      name: "Wyatt Rice",
...
<div class="aboutContainer">
  ...
  <section class="aboutApp">
    <div class="generalDesc">
      ...
      <p>
        ...
        >. Cookies in the form of local storage entries are used to store your
        configuration.
      </p>
      <p>
    ...
    <div class="areaDesc">
      ...
      <div class="myHeroesDesc areaDescSect">
        ...
        <div class="text">
          <p>
            Your hero box away from home. Keep track of all of your hero
            investments, and if you are new to the game, keep track of the
            copies you are collecting for the heroes you own. If you don't want
            personalized <em>Recommendations</em>, then there's no need to
  ...
  <section class="affiliate">
    <div class="disclaimer">
      <span
        ...
        or
        <a
          href="https://www.afkarena.com/"
          target="_blank"
          rel="noreferrer noopener">AFK Arena</a
        ></span
      >
    </div>
  </section>
  <section class="config">
    <button
      type="button"
      class="configButton clearButton"
      on:click={handleClearDataButtonClick}><span>Clear Data</span></button
    >
    <button
      type="button"
      class="configButton tutorialButton"
      on:click={handleTutorialButtonClick}><span>Reset Tutorial</span></button
    >
    <button
      type="button"
      class="configButton colorButton"
      class:darkButton={$AppData.colorProfile === "light"}
      on:click={handleColorButtonClick}
      ><span
        >{$AppData.colorProfile === "light" ? "Dark Mode" : "Light Mode"}</span
      ></button
    >
    <form
      action="https://forms.gle/oKDQj2Jjqmf5DoTCA"
      target="_blank"
      rel="noreferrer noopener"
    >
      <input
        class="configButton feedbackButton"
        type="submit"
        value="Send Feedback"
      />
    </form>
